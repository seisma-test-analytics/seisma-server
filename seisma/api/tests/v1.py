...
class TestFullCycle(BaseApiTestCse):
    ...
    def test_14_get_builds_by_dates(self):
        resp = self.get(
    ...
    def test_15_get_stat_of_cases_from_job(self):
